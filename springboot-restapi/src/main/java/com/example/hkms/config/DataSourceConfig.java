...
public class DataSourceConfig {
	public static final String MYBATIS_CONFIG_LOCATION_PATH = "classpath:mybatis-config.xml";
	public static final String MYBATIS_MAPPER_LOCATION_PATH = "classpath:mybatis/mapper/**/*.xml";
